...
class Quadpay_WC_Gateway extends WC_Payment_Gateway {
	...
	public function process_payment( $order_id ) {
		...
		$order->update_meta_data( '_quadpay_order_token', $response->token );
		$order->update_meta_data( '_quadpay_order_id', $response->orderId );
		$order->save();
	...
	public function get_quadpay_order_id( $order_id ) {
		...
		$quadpay_order_id = $order->get_meta( '_quadpay_order_id', true );
		...
		$order_token = $order->get_meta( '_quadpay_order_token', true );
		...
		$order->update_meta_data( '_quadpay_order_id', $order_token );
		$order->save();
